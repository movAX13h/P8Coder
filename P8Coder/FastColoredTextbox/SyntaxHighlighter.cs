        ...
        protected void InitLuaRegex()
        {
            ...
            LuaFunctionsRegex =
                new Regex(
                    ...
                    @"\b(load|save|folder|files|run|resume|reboot|stat|info|flip|time|clip|pget|pset|sget|sset|fget|fset|print|cursor|color|cls|camera|circ|circfill|line|rect|rectfill|pal|palt|spr|sspr|map|add|del|count|foreach|all|sub|btn|btnp|sfx|music|mget|mset|peek|poke|memcpy|reload|cstore|memset|flr|abs|sgn|sqrt|max|min|mid|cos|sin|atan2|rnd|srand|band|bor|bxor|bnot|shl|shr)\b",
                    RegexCompiledOption);
        }
